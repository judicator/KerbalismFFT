			...
			if (!kerbalismFound)
			{
				...
				dialog = PopupDialog.SpawnPopupDialog(new Vector2(0.5f, 0.5f),
					...
					new MultiOptionDialog(
						...
						Localizer.Format("#LOC_KerbalismFFT_KerbalismNotFound_Msg"),
						Localizer.Format("#LOC_KerbalismFFT_KerbalismNotFound_Title"),
						HighLogic.UISkin,
						new Rect(0.5f, 0.5f, 500f, 60f),
						new DialogGUIFlexibleSpace(),
						new DialogGUIHorizontalLayout(
							new DialogGUIFlexibleSpace(),
							new DialogGUIButton(Localizer.Format("#LOC_KerbalismFFT_Quit"), Application.Quit, 140.0f, 30.0f, true),
							new DialogGUIFlexibleSpace()
						)
					),
					true,
